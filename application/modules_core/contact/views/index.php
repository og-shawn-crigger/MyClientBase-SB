        ...
        <div class="content toggle no_padding">
            ...
            <table>
                <tr>
                    <th scope="col" class="first">
                        <?php if ($this->uri->segment(4) == 'client_id_desc') {
                            echo anchor('contact/index/order_by/client_id_asc', $this->lang->line('id'));
                        } else {
                            echo anchor('contact/index/order_by/client_id_desc', $this->lang->line('id'));
                        } ?>
                    </th>
                    <th scope="col" >
                        <?php if ($this->uri->segment(4) == 'client_name_desc') {
                            echo anchor('contact/index/order_by/client_name_asc', $this->lang->line('name'));
                        } else {
                            echo anchor('contact/index/order_by/client_name_desc', $this->lang->line('name'));
                        } ?>
                    </th>
                    <th scope="col" class="col_amount">
                        <?php if ($this->uri->segment(4) == 'balance_desc') {
                            echo anchor('contact/index/order_by/balance_asc', $this->lang->line('balance'));
                        } else {
                            echo anchor('contact/index/order_by/balance_desc', $this->lang->line('balance'));
                        } ?>
                    </th>
                ...
                <tr class="hoverall">
					...
					<?php } ?>
                    <td class="last">
                        <a href="<?php echo site_url('contact/details/client_id/' . $client->client_id); ?>" title="<?php echo $this->lang->line('view'); ?>">
                        <?php echo icon('zoom'); ?>
                        </a>
                        <a href="<?php echo site_url('contact/form/client_id/' . $client->client_id); ?>" title="<?php echo $this->lang->line('edit'); ?>">
                        <?php echo icon('edit'); ?>
                        </a>
                        <a href="<?php echo site_url('contact/delete/client_id/' . $client->client_id); ?>" title="<?php echo $this->lang->line('delete'); ?>" onclick="javascript:if(!confirm('<?php echo $this->lang->line('client_delete_warning'); ?>')) return false">
            ...
            <?php if ($this->mdl_contacts->page_links) { ?>
            <div id="pagination">
            <?php echo $this->mdl_contacts->page_links; ?>
            </div>
            <?php } ?>
